    ...
    return (
        <ScrollView>
            ...
            <Center> 
                ...
                <Text_box>
                <State_text>Пятеро женатых старых друзей совместно снимают респектабельный лофт для своих развлечений на стороне. И все идет хорошо, пока однажды они не находят в квартире труп девушки.
                            Отличный образец криминального детектива, сюжет которого строится на низменных основных инстинктах, присущих всем главным героям.</State_text>
                </Text_box>
                <State_phot source = {require('./../assets/state_photo/State_1/photo_1.jpg')}/>
                <Text_box>
                <State_text>Здание, которое мы видим в начале фильма, реально существует, это "930 Poydras" в Новом Орлеане. Однако съемочной бригаде не удалось договорится о съемках в нем, все интерьерные сцены были сняты в бельгийской студии недалеко от Брюсселя.</State_text>
                </Text_box>
                <State_phot source = {require('./../assets/state_photo/State_1/photo_2.jpg')}/>
                <Text_box>
                <State_text>В 2008 году был снят оригинальный бельгийский фильм «Лофт», а спустя несколько лет появился этот голливудский ремейк. В бельгийском «Лофте» также играл Маттиас Шонартс (роль Филипа) и был тот же режиссер.</State_text>
                </Text_box>
                <State_phot source = {require('./../assets/state_photo/State_1/photo_3.jpg')}/>
                <Text_box>
                <State_text>Сам лофт по задумке создателей должен быть максимально открытым, чтобы герои фильма из любой точки квартиры могли видеть убитую девушку на кровати.</State_text>
                </Text_box>
                <State_phot source = {require('./../assets/state_photo/State_1/photo_4.jpg')}/>
                <Text_box>
                <State_text>
Фильм обязателен к просмотру любителям современных интерьеров, закрученных сюжетов и человеческих пороков.</State_text>
            ...
            <Center>
                ...
                <Text_box>
                    <State_text>Пятеро женатых старых друзей совместно снимают респектабельный лофт для своих
                        ...
                        инстинктах, присущих всем главным героям.</State_text>
                </Text_box>
                <State_phot source={require('./../assets/state_photo/State_1/photo_1.jpg')}/>
                <Text_box>
                    <State_text>Здание, которое мы видим в начале фильма, реально существует, это "930 Poydras" в Новом
                        ...
                        были сняты в бельгийской студии недалеко от Брюсселя.</State_text>
                </Text_box>
                <State_phot source={require('./../assets/state_photo/State_1/photo_2.jpg')}/>
                <Text_box>
                    <State_text>В 2008 году был снят оригинальный бельгийский фильм «Лофт», а спустя несколько лет
                        ...
                        Филипа) и был тот же режиссер.</State_text>
                </Text_box>
                <State_phot source={require('./../assets/state_photo/State_1/photo_3.jpg')}/>
                <Text_box>
                ...
                <Text_box>
                    <State_text>
                        ...
                        человеческих пороков.</State_text>
